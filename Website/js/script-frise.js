...
var eventsTech = [	new Event(1945, "", "Invention du régulateur de vitesse", null, 3, "Le régulateur permet de fixer la vitesse du véhicule jusqu'à ce que le conducteur reprenne le contrôle en touchant l'une des pédales. Le régulateur de vitesse est l'un des premiers outils d'assistance à la conduite. Le régulateur rend la conduite sur les longues portions d'autoroute plus confortable.", null),
					new Event(1950, "Années", "Invention de la direction assistée", null, 3, "La direction assistée aide le conducteur lorsqu'il dirige son véhicule, notamment lorsqu'il effectue un virage. Cet outil qui peut passer inaperçu est une sécurité supplémentaire pour le conducteur.", null),
					new Event(1980, "Années", "Premiers essais de véhicules autonomes", null, 3, "Les premiers essais sur les véhicules autonomes par les constructeurs classiques ne datent pas d'hier. De nombreux prototypes ont été développés partout dans le monde plus ou moins secrètement.", null),
					...
					new Event(2005, "2004 et", "DARPA Grand Challenge.", null, 3, "Ce défi regroupe chaque année les grandes universités scientifiques autour de problématiques technologiques innovantes. En 2004 et 2005 se sont tenues des courses de véhicules sans conducteur. La première édition a connu un faible taux de réussite des participants qui ne parvenaient pas pour la plupart à faire parcourir au véhicule plus de quelques mètres. En revanche, l'édition suivante a vu s'illustrer l'équipe de Stanford qui remporta la course avec brio.", null),
					new Event(2009, "", "Projet de la Google Car", null, 2, "Lancement du projet de la Google Car", null),
					new Event(2010, "Années", "Projets de développement de voitures autonomes", null, 2, "La première vague des projets visant à une production future voit le jour partout dans le monde. Les constructeurs de véhicules classiques réagissent aux ambitions de Google.", null),
					new Event(2012, "Août", "300 000 miles dépassée par les Google Car", "road", 3, "La flotte de Google cars dépasse la barre des 300 000 miles. Cette distance a été parcourue par des équipes de deux. Les testeurs devront encore rester dans le siège du conducteur afin de reprendre le contrôle du véhicule en cas de nécessité.", null),
					new Event(2015, "", "Autopilot de Tesla", null, 3, "Tesla rend disponible son logiciel d'autopilotage aux véhicules équipés. Le logiciel est distribué \"Over The Air\" comme des mises-à-jour logicielles de téléphones mobiles.", "https://en.wikipedia.org/wiki/Tesla_Motors")];

var eventsLaw = [	new Event(1968, "", "Convention de Vienne", "list-alt", 3, "La convention de Vienne 8 novembre 1968 régule la circulation routière à l'échelle mondiale. Elle prévoit en son article 8 que toute voiture doit avoir un conducteur en état physique et mental nécessaire pour conduire, et doit avoir acquis les connaissances essentielles à la conduite afin de garder constamment le contrôle de son véhicule.", null),
					...
					new Event(2004, "", "Limiteur de vitesse obligatoire", null, 3, "Le Comité Interministériel de Sécurité Routière du 18 décembre 2002 a prévu que l'État équiperait tous ses nouveaux véhicules de limiteurs de vitesse à compter du 1er janvier 2004.", "http://www.securite-routiere.gouv.fr/medias/espace-presse/publications-presse/limiteur-et-regulateur-de-vitesse-quelques-definitions-apportees-par-la-securite-routiere"),
					new Event(2011, "", "Le Nevada autorise les voitures autonomes", null, 3, "L'État américain du Nevada est le premier à autoriser la circulation des véhicules autonomes sur son territoire.", null),
					new Event(2015, "", "Loi de Transition Énergétique", null, 2, "La loi de la transition énergétique portée par Ségolène Royal confère au gouvernement français le recours aux ordonnances pour permettrent la circulation des véhicules autonomes.", null),
					new Event(2015, "Juin", "McKinsey redéfinit le monde automobile", "list-alt", 2, "Publication par McKinsey d'un rapport sur l'éventuelle redéfinition du monde de l'automobile par les véhicules autonomes. Le rapport énumère les différents bénéfices éventuels engendrés par l’adoption complète des voitures autonomes. À savoir une réduction drastique des accidents de la route (jusqu’à 90% ce qui pourrait permettre d’économiser jusqu’à 190 milliards de dollars rien qu’aux US) et une augmentation du temps de loisir (jusqu’à 50 minutes quotidiennes ce qui pourrait générer 5 milliards de dollars annuels pour chaque minute additionnelle passée sur Internet avec son téléphone mobile dans le secteur des médias digitaux).", "http://www.mckinsey.com/industries/automotive-and-assembly/our-insights/ten-ways-autonomous-driving-could-redefine-the-automotive-world"),
					new Event(2015, "Octobre", "Volvo annonce prendre la responsabilité de ses accidents", null, 2, "Annonce de l'entière responsabilité de ses véhicules autonomes assumée par Håkan Samuelsson (PDG Volvo). Dès lors que le véhicule sera en mode autonome, le constructeur assumera l'entière responsabilité de tout accident causé par celui ci. Il appelle aussi les régulateurs américains et européens à accélérer le processus de tests et de certifications pour les véhicules autonomes", "http://fortune.com/2015/10/07/volvo-liability-self-driving-cars/"),
					new Event(2015, "Décembre", "Réglementations adurcies en Californie", null, 2, "Le département des véhicules à moteur(DMC) de Californie a publié une série de recommandations aux sujets du déploiement des véhicules autonomes. Il prévoit notamment que les conducteurs disposent d’un permis de conduire spécifique ainsi que l’entière responsabilité leur soit incombée en cas d’accident et ce quand bien même ils ne contrôleraient pas le véhicule.", "https://www.dmv.ca.gov/portal/wcm/connect/ed6f78fe-fe38-4100-b5c2-1656f555e841/AVExpressTerms.pdf?MOD=AJPERES"),
					new Event(2016, "Février", "L'intelligence artificielle devient \"conducteur\"", null, 2, "La NHTSA (National Highway Traffic Safety Agency) accepte de considérer l'intelligence artificielle de la Google Car comme étant le conducteur responsable du véhicule.", "http://droitdu.net/2016/03/vers-un-encadrement-juridique-de-la-voiture-autonome/"),
...
var eventsDiv = [	new Event(1957, "", "Minority Report", null, 3, "L'œuvre de Philip K. Dick est l'une des premières apparitions des véhicules autonomes dans la littérature.", null),
					...
					new Event(2016, "Février", "Premier accrochage responsable d'une Google Car", "fire", 2, "Accrochage mineur d'une Google Car Lexus avec un bus sur une route Californienne à Mountain View. Le véhicule s'est inséré sur une voie, bloquant ainsi la route à un bus, après avoir été bloqué par des travaux sur le bas-côté de la voie qu'elle empruntait. La Google Car roulait à quelques km/h tandis que le bus l'a percuté à environ 25 km/h. Il s'agit du premier accrochage impliquant une Google Car où l'intelligence artificielle développée par Google est directement fautive.", "https://www.wired.com/2016/02/googles-self-driving-car-may-caused-first-crash/"),
					new Event(2016, "Avril", "Consumer Watchdog critique la Google Car", null, 2, "Consumer Watchdog, association de consommateurs américain, adresse une série de 10 questions à Google au sujet de la sécurité par le biais de la NHTSA (National Highway Traffic Safety Agency). Consumer Watchdog s'oppose à l'abandon du volant dans les prototypes développés par Google et plus généralement à l'absence de conducteur dans un véhicule.", "http://www.consumerwatchdog.org/newsrelease/google%E2%80%99s-proposal-%E2%80%9Cfast-track%E2%80%9D-approval-driverless-cars-threat-public-safety-consumer-wa"),
					new Event(2020, "", "Objectif zéro mort ou blessé grave pour Volvo", null, 3, "Le constructeur Volvo se donne pour objectif d'atteindre zéro mort ou blessé grave dans un accident impliquant un véhicule récent de la marque Volvo d'ici 2020. Cette annonce affiche clairement les ambitions de Volvo à mener à terme son projet de véhicules autonomes garantissant une meilleure sécurité pour les passagers ainsi que l'entière responsabilité assumée par Volvo.", null)];
